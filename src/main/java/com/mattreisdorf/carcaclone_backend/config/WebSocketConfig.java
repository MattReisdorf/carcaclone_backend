...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
  ...
  public WebSocketConfig(PlayerSessionService playerSessionService) {
    ...
    registry
        ...
        .setHandshakeHandler(new DefaultHandshakeHandler() {
          ...
          protected Principal determineUser(@SuppressWarnings("null") ServerHttpRequest request,
            ...
            try {
              PlayerSessionResponse player = playerSessionService.getPlayerFromAttributes(attributes);
              return new StompPrincipal(player.playerId(), player.playerName());
